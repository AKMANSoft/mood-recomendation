...
export default function LoginPage() {
    ...
    return (
        <div className="">
            ...
            <HeaderComponent />
            {/* Content */}
            <div className="bg-primary  min-h-screen  flex items-center justify-center overflow-hidde ">
                <div className="">
                    <div
                        className="md:w-[446px] w-auto  flex flex-col items-center justify-center bg-white mx-4 md:mx-0 pt-10 rounded-lg">
                        <div>
